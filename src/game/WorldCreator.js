...
define(['ash', 'game/vos/ResourcesVO', 'game/constants/WorldCreatorConstants', 'game/constants/EnemyConstants'],
function (Ash, ResourcesVO, WorldCreatorConstants, EnemyConstants) {
    ...
    var WorldCreator = {
		...
		prepareWorldTexture: function(seed, topLevel, bottomLevel) {
			...
			for(var s = firstSector; s <= lastSector; s++) {
				...
				// sunlight
				this.world[l][s].sunlit = l == topLevel || (l == topLevel-1 && ceilingStateOfRepair < 2) || (edgeSector && stateOfRepair < 2);
			...
			// this.printWorld(seed, [ "buildingDensity" ]);
		},
