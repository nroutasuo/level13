define([
    ...
    var EnemyHelper = Ash.Class.extend({
        ...
        createEnemies: function () {
            ...
            definitions.global.push(this.createEnemy("rusted guard bot", "global", [c.nPest, c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aPatrol, c.aGuard, c.aInfest], [c.dDisabled], 10, 5, 0.5, 65));
            definitions.global.push(this.createEnemy("ancient guard bot", "global", [c.nPest, c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aPatrol, c.aGuard, c.aInfest], [c.dDisabled], 11, 5, 0.3, 65));
            definitions.global.push(this.createEnemy("robot from a forgotten war", "global", [c.nPest, c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aGuard, c.aInfest], [c.dDisabled], 12, 5, 0.5, 60));
            definitions.global.push(this.createEnemy("drone from a forgotten war", "global", [c.nPest, c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aGuard, c.aInfest], [c.dDisabled], 13, 5, 0.5, 60));
            definitions.global.push(this.createEnemy("malfunctioning fire door", "global", [c.nBot], [], [c.aGuard], [c.dDisabled], 14, 7, 0.1, 65));
            definitions.global.push(this.createEnemy("antagonistic fire door", "global", [c.nBot], [], [c.aGuard], [c.dDisabled], 15, 7, 0.2, 50));
            definitions.global.push(this.createEnemy("territorial sewer varanid", "global", [c.nAnimal], [c.gPack, c.gGang], [c.aGuard], [c.dKilled, c.dDrive], 16, 8, 0.7, 85));
            definitions.global.push(this.createEnemy("predatory sewer varanid", "global", [c.nAnimal], [c.gPack, c.gGang], [c.aGuard], [c.dKilled, c.dDrive], 17, 8, 0.8, 85));
            definitions.global.push(this.createEnemy("haywire guard bot 1", "global", [c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aPatrol, c.aGuard, c.aInfest], [c.dDisabled], 18, 5, 0.2, 50));
            definitions.global.push(this.createEnemy("haywire guard bot 2", "global", [c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aPatrol, c.aGuard, c.aInfest], [c.dDisabled], 19, 5, 0.7, 50));
            definitions.global.push(this.createEnemy("haywire guard bot 3", "global", [c.nBot], [c.gGang, c.gSwarm, c.gMob], [c.aPatrol, c.aGuard, c.aInfest], [c.dDisabled], 20, 5, 0.6, 50));
            definitions.earth.push(this.createEnemy("wasp", "earth", [c.nAnimal], [c.gSwarm], [c.aInfest], [c.dDrive], 5, 5, 0.75));
            definitions.earth.push(this.createEnemy("bee", "earth", [c.nAnimal], [c.gSwarm], [c.aInfest], [c.dDrive], 6, 5, 0.25, 70));
            definitions.earth.push(this.createEnemy("spirit of earth", "earth", [], [], [c.aGuard], [c.dDrive], 7, 5, 0.2, 25));
            definitions.earth.push(this.createEnemy("spirit of wind", "earth", [], [], [c.aGuard], [c.dDrive], 8, 8, 0.8, 35));
            definitions.earth.push(this.createEnemy("spirit of fire", "earth", [], [], [c.aGuard], [c.dDrive], 9, 6, 0.6, 45));
            definitions.earth.push(this.createEnemy("spirit of sun", "earth", [], [], [c.aGuard], [c.dDrive], 10, 6, 0.2, 55));
            definitions.earth.push(this.createEnemy("vengeful dryad", "earth", [], [c.gMob], [c.aGuard], [c.dDrive], 11, 8, 0.5, 90));
            definitions.earth.push(this.createEnemy("vampire", "earth", [], [], [], [c.dDrive], 12, 8, 0.8, 90));
            definitions.earth.push(this.createEnemy("ape", "earth", [c.nAnimal], [c.gPack, c.gGang, c.gMob], [c.aGuard], [c.dDrive], 13, 5, 0.5));
            definitions.earth.push(this.createEnemy("bear", "earth", [c.nAnimal], [], [], [c.dDrive], 14, 6, 0.6));
            definitions.earth.push(this.createEnemy("drove of boars", "earth", [c.nAnimal], [], [], [c.dDrive], 15, 5, 0.8));
            definitions.inhabited.push(this.createEnemy("security bot", "inhabited", [c.nBot], [c.gMob], [c.aPatrol, c.aGuard], [c.dDisabled], 14, 5, 0.3));
            definitions.inhabited.push(this.createEnemy("rabid dog", "inhabited", [c.nPest, c.nAnimal], [c.gPack], [c.aInfest], [c.dKilled], 15, 5, 0.6));
            definitions.inhabited.push(this.createEnemy("leaking gas pipe", "inhabited", [], [], [], [c.dCleared], 16, 4, 0.2, 75));
            definitions.inhabited.push(this.createEnemy("mugger", "inhabited", [c.nGangster], [c.gGang], [c.aInfest], [c.dDrive], 17, 5, 0.5, 15));
            definitions.inhabited.push(this.createEnemy("doomsayer", "inhabited", [], [c.gMob], [c.aPatrol], [c.dDrive], 18, 4, 0.6, 45));
            definitions.inhabited.push(this.createEnemy("armed gangster", "inhabited", [c.nGangster], [c.gMob, c.gGang], [c.aPatrol, c.aGuard, c.aInfest], [], 19, 6, 0.8, 75));
            definitions.inhabited.push(this.createEnemy("sector emergency system", "inhabited", [c.nBot], [], [c.aGuard], [], 20, 5, 0.7, 25));
            definitions.sunlit.push(this.createEnemy("thorny bush", "sunlit", [c.nPest], [c.gCluster], [c.aInfest, c.aCover], [], 1, 5, 0.5));
            definitions.sunlit.push(this.createEnemy("overgrown nettle", "sunlit", [c.nPest], [c.gCluster], [c.aInfest, c.aCover], [], 2, 5, 0.25));
            definitions.sunlit.push(this.createEnemy("hawk", "sunlit", [c.nPest, c.nAnimal], [c.gFlock, c.gPack], [c.aInfest], [], 3, 5, 0.3, 50));
            definitions.sunlit.push(this.createEnemy("a group of seagulls", "sunlit", [c.nPest, c.nAnimal], [c.gFlock], [c.aInfest], [], 4, 6, 0.8, 20));
            definitions.sunlit.push(this.createEnemy("scorpion", "sunlit", [c.nPest, c.nAnimal], [c.gSwarm, c.gMob], [c.aInfest], [], 5, 5, 0.7));
            definitions.sunlit.push(this.createEnemy("territorial magpie", "sunlit", [c.nPest, c.nAnimal], [], [c.aInfest], [], 6, 4, 0.7, 35));
            definitions.sunlit.push(this.createEnemy("great black pelican", "sunlit", [c.nPest, c.nAnimal], [], [c.aInfest, c.aGuard], [c.dKilled, c.dDrive], 9, 5, 0.5, 35));
            definitions.urban.push(this.createEnemy("swarm of pidgeons", "urban", [c.nPest, c.nAnimal], [c.gFlock, c.gSwarm], [c.aInfest], [c.dDrive], 14, 5, 0.75, 10));
            definitions.urban.push(this.createEnemy("agitated murder of crows", "urban", [c.nPest, c.nAnimal], [c.gFlock, c.gSwarm], [c.aInfest], [c.dDrive], 15, 5, 0.3));
            definitions.urban.push(this.createEnemy("aggressive raccoon", "urban", [c.nPest, c.nAnimal], [], [], [], 16, 5, 0.6, 40));
            definitions.urban.push(this.createEnemy("escaped pet boa", "urban", [c.nAnimal], [], [c.aInfest], [], 17, 7, 0.5, 85));
            definitions.urban.push(this.createEnemy("military bot", "urban", [c.nBot], [c.gMob], [c.aPatrol, c.aGuard], [c.dDisabled], 18, 5, 0.8, 85));
            definitions.urban.push(this.createEnemy("escaped zoo panther", "urban", [c.nAnimal, c.aGuard], [c.gPack, c.gMob], [], [], 19, 8, 0.8, 90));
            definitions.urban.push(this.createEnemy("injured zoo panther", "urban", [c.nAnimal], [c.gPack, c.gMob], [], [], 20, 8, 0.6, 95));
        },

        // Enemy definitions (level: level ordinal, difficulty: 1-10, attRatio: 0-1, rarity: 0-100)
        createEnemy: function (name, type, nouns, groupN, activeV, defeatedV, level, normalizedDifficulty, attRatio, rarity) {
