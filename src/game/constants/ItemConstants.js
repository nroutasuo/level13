define(['ash', 'game/vos/ItemVO'], function (Ash, ItemVO) {
    ...
    var ItemConstants = {
		...
		itemDefinitions: {
			light: [
				new ItemVO("light1", "Lantern", "Light", 25, true, true, "img/items/light-lantern.png",
						   "Feeble light for basic survival in the dark undercorridors."),
				new ItemVO("light2", "Electric light", "Light", 75, true, true, "img/items/light-electric.png",
						   "Advanced light for serious travellers."),
				new ItemVO("light3", "Ghost light", "Light", 125, true, false, "img/items/light-ghost.png",
						   "They say the ghost light can show you more the darker places you go."),
			],
			shades: [
				new ItemVO("shade1", "Basic goggles", "Shades", 25, true, true, "img/items/shades-basic.png",
						   "Improvised protection from sunlight."),
				new ItemVO("shade2", "Sporty sunglasses", "Shades", 75, true, true, "img/items/shades-fancy.png",
						   "Good sunglasses help keep the blinding rays to a minimum."),
			],
			weapon: [
				new ItemVO("weapon1", "Shiv", "Weapon", 2, true, true, "img/items/weapon-shiv.png",
						   "Improvised sharp poking implement."),
				new ItemVO("weapon2", "Spear", "Weapon", 5, true, true, "img/items/weapon-shiv.png",
						   "Old-fashioned but reliable weapon."),
				new ItemVO("weapon3", "Crossbow", "Weapon", 11, true, true, "img/items/weapon-shiv.png",
						   "A deadly ranged weapon consisting of a horizontal limb assembly mounted on a stock that shoots projectiles."),
				new ItemVO("weapon4", "Pistol", "Weapon", 24, true, true, "img/items/weapon-bomb.png",
						   "A crude single-shot pistol, like a hand-held miniature cannon."),
				new ItemVO("weapon5", "Revolver", "Weapon", 52, true, true, "img/items/weapon-bomb.png",
						   "A more sophisticated handgun that allows several shots before reloading."),
				new ItemVO("weapon6", "Custom SMG", "Weapon", 116, true, true, "img/items/weapon-bomb.png",
						   "It may be made from scrap metal but it is still a serious weapon."),
				new ItemVO("weapon7", "Improvised bazooka", "Weapon", 225, true, true, "img/items/weapon-bomb.png",
			...
			clothing: [
				...
				new ItemVO("clothing4", "Kevlar vest", "Clothing", 21, true, true, "img/items/clothing-2.png",
						   "Heavy, but worth it."),
				new ItemVO("clothing5", "Scrap metal armor", "Clothing", 51, true, true, "img/items/clothing-3.png",
						   "Perfect apparel for the post-apocalyptic knight."),
				new ItemVO("clothing6", "Adapted security uniform", "Clothing", 126, true, true, "img/items/clothing-3.png",
			...
			shoes: [
				...
				new ItemVO("shoe_2", "Worn trainers", "Shoes", 0.8, true, false, "img/items/shoe-2.png",
						   "Decent, reasonable shoes for walking in most places."),
				new ItemVO("shoe_3", "Hiking boots", "Shoes", 0.5, true, false, "img/items/shoe-3.png",
			...
			artefact: [
				new ItemVO("artefact_ground_1", "Runestone", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Puzzling piece of stone with an ancient rune on it."),
				new ItemVO("artefact_ground_2", "Charred seed", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Seeds are said to contain life itself. They do not grow in the dark city."),
				new ItemVO("artefact_ground_3", "Round stone", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Smooth stone that fits in the palm of a hand. There is something calming about it."),
				new ItemVO("artefact_ground_4", "Leather pouch", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Small leather pouch with a string that allows it to be worn around the neck. All it contains is some kind of a powder."),
				new ItemVO("artefact_surface_1", "Canned tuna", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Leftovers from a bygone time. They say there used to be fish tanks, somewhere near the surface."),
				new ItemVO("artefact_surface_2", "ID Chip", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Chips like these used to be placed under people's skins, giving them certain powers. It probably doesn't work anymore."),
				new ItemVO("artefact_surface_3", "Scientist's notebook", "Artefact", 0, false, false, "img/items/artefact-test.png",
				...
				new ItemVO("artefact_history_1", "Fountain pen", "Artefact", 0, false, false, "img/items/artefact-test.png",
				...
				new ItemVO("artefact_history_2", "Pearl", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "A beautiful orb said to have formed in the Sea, a massive body of water that is the origin of all life."),
				new ItemVO("artefact_history_3", "CD", "Artefact", 0, false, false, "img/items/artefact-test.png",
				...
				new ItemVO("artefact_doom_1", "Volcanic rock", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Unnerving piece of black rock. Something is etched on it in an unfamiliar language."),
				new ItemVO("artefact_doom_2", "Temple key", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Heavy key with a demonic eel-like ornament so intricately carved it feels almost alive. Strangely cold to the touch."),
				new ItemVO("artefact_doom_3", "Seashell", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Fragile, yellow and light pink shell that must have been looted from a museum."),
				new ItemVO("artefact_doom_4", "Pamphlet", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Bold political leaflet printed on thick paper urging residents of the 'sewers' to rebel against segregation."),
				new ItemVO("artefact_doom_5", "Starchart", "Artefact", 0, false, false, "img/items/artefact-test.png",
						   "Complicated astrological map with calculations indicating an event occurring on year 783."),
			],
			ingredient: [
				new ItemVO("res_matches", "Matches", "Ingredient", 0, false, false, "img/items/res-matches.png", "Used for crafting."),
