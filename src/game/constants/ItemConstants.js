...
function (Ash, WorldCreatorConstants, PlayerActionConstants, UpgradeConstants, ItemVO) {
    ...
    var ItemConstants = {
        ...
        itemDefinitions: {
            ...
            weapon: [
                new ItemVO("weapon1", "Shiv", "Weapon", 1, true, true, false, 2, 2, {atk: 2}, "img/items/weapon-shiv.png", "Improvised sharp poking implement."),
                new ItemVO("weapon12", "Knife", "Weapon", 2, true, true, false, 2, 1, {atk: 3}, "img/items/weapon-shiv.png", "A bit sturdier than the shiv."),
