	...
	var ItemConstants = {
		...
		initDefinitions: function () {
			...
			this.itemDefinitions.weapon = [
				...
				new ItemVO("weapon25", "Heavy Axe", "Weapon", 5, true, true, false, 3, 1, {atk: 12, spd: 0.6}, "img/items/weapon-shiv.png", "Easy to use and reliable."),
			...
			this.itemDefinitions.clothing_over = [
				...
				new ItemVO("clothing_over_l14", "Hazmat suit", "Armor", 8, true, true, false, -1, -1, {movement: 1.1, def: 1, warmth: 5, res_rad: 15, res_poison: 15}, "img/items/clothing-2.png", "Effective protection against radiation, but clumsy to move around in.", true),
			...
			this.itemDefinitions.clothing_hands = [
				...
				new ItemVO("clothing_hands_l14", "Hazmat gloves", "Hands", 8, true, true, false, -1, -1, {def: 2, warmth: 5, res_rad: 10, res_poison: 10}, "img/items/clothing-hand-0.png", "Protection from environmental hazards.", true),
			...
			this.itemDefinitions.exploration = [
				...
				new ItemVO("stamina_potion_1", "Rejuv shot", "Exploration", 1, false, false, true, 8, 2, {}, "img/items/stamina-1.png", "Smells awful, but restores stamina."),
			];
