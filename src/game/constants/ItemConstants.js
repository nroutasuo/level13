    ...
    var ItemConstants = {
        ...
        itemDefinitions: {
            ...
            clothing_upper: [
                ...
                new ItemVO("clothing_upper_15", "T-shirt", "Shirt", { "fight defence": 1, warmth: 2, "radiation protection": 1, "poison protection": 1}, true, false, false, "img/items/clothing-rags.png",
                    "Standard shirt.", 2, 2, 1),
                new ItemVO("clothing_upper_2", "Factory uniform shirt", "Shirt", {"fight defence": 2, warmth: 3, "radiation protection": 1, "poison protection": 1}, true, false, false, "img/items/clothing-2.png",
                    "Feels oddly comfortable in dark corridors and abandoned factories.", 5, 1, 1),
                new ItemVO("clothing_upper_3", "Guard uniform shirt", "Shirt", {"fight defence": 5, warmth: 10, "radiation protection": 3, "poison protection": 3}, true, true, false, "img/items/clothing-2.png",
