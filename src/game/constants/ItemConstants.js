    ...
    var ItemConstants = {
		...
		itemDefinitions: {
			...
			artefact: [
				...
				new ItemVO("artefact_doom_3", "Seashell", "Seashell", 0, false, false, "img/items/artefact-test.png",
						   "Fragile, yellow and light pink shell that must have been looted from a museum."),
				new ItemVO("artefact_doom_4", "Pamphlet", "Seashell", 0, false, false, "img/items/artefact-test.png",
