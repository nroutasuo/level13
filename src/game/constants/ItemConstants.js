...
function (Ash, WorldCreatorConstants, PlayerActionConstants, UpgradeConstants, ItemVO) {
    ...
    var ItemConstants = {
        ...
        itemDefinitions: {
            ...
            weapon: [
                new ItemVO("weapon1", "Shiv", "Weapon", 1, true, true, false, 2, 2, {"fight attack": 2}, "img/items/weapon-shiv.png", "Improvised sharp poking implement."),
                new ItemVO("weapon12", "Knife", "Weapon", 2, true, true, false, 2, 1, {"fight attack": 3}, "img/items/weapon-shiv.png", "A bit sturdier than the shiv."),
                new ItemVO("weapon2", "Spear", "Weapon", 4, true, true, false, 3, 1, {"fight attack": 5}, "img/items/weapon-shiv.png", "Old-fashioned but reliable weapon."),
                new ItemVO("weapon25", "Heavy Axe", "Weapon", 5, true, true, false, 3, 1, {"fight attack": 8}, "img/items/weapon-shiv.png", "Easy to use and reliable."),
                new ItemVO("weapon3", "Crossbow", "Weapon", 6, true, true, false, 3, 1, {"fight attack": 12}, "img/items/weapon-shiv.png", "A deadly ranged weapon consisting of a horizontal limb assembly mounted on a stock that shoots projectiles."),
                new ItemVO("weapon4", "Pistol", "Weapon", 8, true, true, false, 4, 1, {"fight attack": 24}, "img/items/weapon-bomb.png", "A crude single-shot pistol, like a hand-held miniature cannon."),
                new ItemVO("weapon5", "Revolver", "Weapon", 10, true, true, false, 4, 1, {"fight attack": 30}, "img/items/weapon-bomb.png", "A more sophisticated handgun that allows several shots before reloading."),
                new ItemVO("weapon52", "Scrap Metal Waraxe", "Weapon", 11, true, true, false, 1, 1, {"fight attack": 34}, "img/items/weapon-bomb.png", "A formidable axe specifically designed for combat"),
                new ItemVO("weapon58", "Crude Shotgun", "Weapon", 12, true, true, false, 5, 1, {"fight attack": 55}, "img/items/weapon-bomb.png", "Devastating short-range firearm."),
                new ItemVO("weapon6", "Custom SMG", "Weapon", 13, true, true, false, 5, 2, {"fight attack": 116}, "img/items/weapon-bomb.png", "It may be made from scrap metal but it is still a serious weapon."),
                new ItemVO("weapon7", "Improvised bazooka", "Weapon", 14, true, true, false, 3, 3, {"fight attack": 205}, "img/items/weapon-bomb.png", "Powerful but heavy and somewhat unreliable construction of pipes, reclaimed weapon parts and improvised ammunition."),
                new ItemVO("weapon8", "Rifle", "Weapon", 15, true, true, false, 3, 3, {"fight attack": 245}, "img/items/weapon-bomb.png", "Deadly weapon similar to those that were mass-produced just before the Fall."),
            ],
            clothing_over: [
                new ItemVO("clothing_over_1", "Warm Coat", "Armor", 1, true, true, false, 5, 1, {"fight defence": 1, warmth: 20}, "img/items/clothing-2.png", "Something against the chill."),
                new ItemVO("clothing_over_1x", "Lab Coat", "Armor", 2, true, false, false, 5, 1, {"fight defence": 1, warmth: 2, "poison protection": 10}, "img/items/clothing-2.png", "Might protect from environmental hazards."),
                new ItemVO("clothing_over_2", "Biker jacket", "Armor", 3, true, false, false, 2, 1, {"fight defence": 6, warmth: 10, "radiation protection": 3, "poison protection": 3}, "img/items/clothing-2.png", "Doesn't make one invincible, but feels like it."),
                new ItemVO("clothing_over_25", "Army Jacket", "Armor", 6, true, false, false, 2, 1, {"fight defence": 15, warmth: 10, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-2.png", "Something that's actually produced with the aim of keeping one safe."),
                new ItemVO("clothing_over_3", "Scrap metal armor", "Armor", 8, true, true, false, 5, 2, {"fight defence": 25, warmth: 5, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-2.png", "An ugly but surprisingly comfortable metal blanket"),
                new ItemVO("clothing_over_4", "Kevlar vest", "Armor", 10, true, true, false, 3, 2, {"fight defence": 40, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-2.png", "Heavy, but worth it."),
                new ItemVO("clothing_over_45", "Scavenger vest", "Armor", 12, true, true, false, 3, 1, {"fight defence": 40, warmth: 20, "radiation protection": 10, "poison protection": 10}, "img/items/clothing-2.png", "Novel technology for maximal survival in the post-Fall City"),
                new ItemVO("clothing_over_5", "Riot police vest", "Armor", 13, true, false, false, 2, 2, {"fight defence": 100, warmth: 10, "radiation protection": 0, "poison protection": 10}, "img/items/clothing-3.png", "Based on the old Surface Guard uniform with additional environmental proection."),
                new ItemVO("clothing_over_6", "Exoskeleton", "Armor", 15, true, true, false, 8, 5, {"fight defence": 290, warmth: 10, "radiation protection": 30, "poison protection": 20}, "img/items/clothing-3.png", "Futuristic armour designed for those exploring the world outside the City's protective walls."),
            ],
            clothing_upper: [
                ...
                new ItemVO("clothing_upper_15", "T-shirt", "Shirt", 2, true, false, false, 2, 1, { "fight defence": 1, warmth: 2, "radiation protection": 1, "poison protection": 1}, "img/items/clothing-shirt.png", "Standard shirt."),
                new ItemVO("clothing_upper_2", "Factory uniform shirt", "Shirt", 5, true, false, false, 1, 1, {"fight defence": 2, warmth: 3, "radiation protection": 1, "poison protection": 1}, "img/items/clothing-shirt-2.png", "Feels oddly comfortable in dark corridors and abandoned factories."),
                new ItemVO("clothing_upper_3", "Guard uniform shirt", "Shirt", 8, true, true, false, 1, 1, {"fight defence": 5, warmth: 10, "radiation protection": 3, "poison protection": 3}, "img/items/clothing-shirt-2.png", "Looks official, but not particularly protective."),
                new ItemVO("clothing_upper_35", "Synthetic shirt", "Shirt", 10, true, false, false, 2, 2, {"fight defence": 5, warmth: 12, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-2.png", "Shirt made from recycled advanced textiles used before the Fall."),
                new ItemVO("clothing_upper_4", "Protective shirt", "Shirt", 12, true, true, false, 5, 1, {"fight defence": 8, warmth: 15, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-3.png", "Specifically made for keeping travellers warm and safe."),
                new ItemVO("clothing_upper_45", "Explorer's shirt", "Shirt", 13, true, false, false, 2, 2, {"fight defence": 10, warmth: 15, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-3.png", "Comes with many pockets."),
                new ItemVO("clothing_upper_5", "Scavenger's raincoat", "Shirt", 15, true, true, false, 4, 2, {"fight defence": 0, warmth: 25, "radiation protection": 40, "poison protection": 60}, "img/items/clothing-3.png", "The best protection an explorer can hope for."),
            ],
            clothing_lower: [
                ...
                new ItemVO("clothing_lower_15", "Basic pants", "Legs", 2, true, true, false, 3, 1, {"fight defence": 1, warmth: 1}, "img/items/clothing-rags.png", "Nothing wrong with these pants"),
                new ItemVO("clothing_lower_2", "Factory uniform pants", "Legs", 5, true, false, false, 1, 1, {"fight defence": 1, warmth: 5}, "img/items/clothing-2.png", "Used to be the standard uniform in the dark levels of the City."),
                new ItemVO("clothing_lower_3", "Guard uniform pants", "Legs", 8, true, true, false, 1, 2, {"fight defence": 3, warmth: 8}, "img/items/clothing-2.png", "Looks official, but not particularly protective."),
                new ItemVO("clothing_lower_4", "Padded pants", "Legs", 11, true, true, false, 3, 3, {"fight defence": 15, warmth: 10}, "img/items/clothing-3.png", "Protects from bites and scratches."),
                new ItemVO("clothing_lower_45", "Explorer's pants", "Legs", 13, true, true, false, 5, 2, {"fight defence": 15, warmth: 10, "radiation protection": 5, "poison protection": 5}, "img/items/clothing-3.png", "Protects from bites and scratches."),
                new ItemVO("clothing_lower_5", "Long underwear", "Legs", 15, true, true, false, 3, 1, {"fight defence": 5, warmth: 50, "radiation protection": 1, "poison protection": 1}, "img/items/clothing-3.png", "Nothing keeps you warm like long underwear."),
            ],
            clothing_head: [
                new ItemVO("clothing_head_0", "Sunglasses", "Head", 2, true, false, false, 5, 1, {"sunblindness protection": 30}, "img/items/clothing-hat-1.png", "If there was any sunlight, these would probably be handy."),
                new ItemVO("clothing_head_1", "Wool hat", "Head", 2, true, true, false, 3, 1, {"fight defence": 1, warmth: 10}, "img/items/clothing-hat-1.png", "Warm basic headwear."),
                new ItemVO("clothing_head_2", "Medical mask", "Head", 4, true, false, false, 5, 1, {"poison protection": 15}, "img/items/clothing-hat-1.png", "Meager protection against the effects of polluted air."),
                new ItemVO("clothing_head_25", "Bike helmet", "Head", 5, true, false, false, 3, 1, {"fight defence": 3}, "img/items/clothing-hat-2.png", "A bit clumsy, but quite useful in a fight."),
                new ItemVO("clothing_head_3", "Scrap metal helmet", "Head", 7, true, true, false, 4, 2, {"fight defence": 5, warmth: 5, "radiation protection": 5, "poison protection": 5, "sunblindness protection": 10}, "img/items/clothing-hat-2.png", "Perfect apparel for the post-apocalyptic hero."),
                new ItemVO("clothing_head_4", "Gas mask", "Head", 11, true, true, false, 2, 1, {"fight defence": 5, warmth: 3, "radiation protection": 15, "poison protection": 30, "sunblindness protection": 10}, "img/items/clothing-hat-2.png", "Gives a definite sense of security in dangerous environments."),
                new ItemVO("clothing_head_45", "Scavenger's hood", "Head", 12, true, true, false, 3, 1, {"fight defence": 10, warmth: 10, "radiation protection": 15, "poison protection": 15, "sunblindness protection": 15}, "img/items/clothing-hat-2.png", "A practical, protective hood that doesn't get in the way."),
                new ItemVO("clothing_head_5", "Explorer's helmet", "Head", 13, true, true, false, 5, 2, {"fight defence": 30, warmth: 15, "radiation protection": 20, "poison protection": 10, "sunblindness protection": 50}, "img/items/clothing-hat-3.png", "Headgear designed specifically for scavenging in the City."),
            ],
            clothing_hands: [
                ...
                new ItemVO("clothing_hands_12", "Leather Gloves", "Hands", 3, true, true, false, 3, 1, {"fight defence": 1, "warmth": 3, "radiation protection": 1, "poison protection": 1}, "img/items/clothing-hand-0.png", "Not only warm but also protective."),
                new ItemVO("clothing_hands_2", "Work gloves", "Hands", 5, true, true, false, 1, 1, {"fight defence": 1, "warmth": 3, "radiation protection": 3, "poison protection": 3}, "img/items/clothing-hand-0.png", "Basic protection for hands."),
                new ItemVO("clothing_hands_25", "Good gloves", "Hands", 7, true, true, false, 2, 1, {"fight defence": 2, "warmth": 3, "radiation protection": 3, "poison protection": 3}, "img/items/clothing-hand-0.png", "Good gloves make scavenging much safer."),
                new ItemVO("clothing_hands_3", "Quality gloves", "Hands", 10, true, true, false, 2, 1, {"fight defence": 2, "warmth": 7, "radiation protection": 5, "poison protection": 10}, "img/items/clothing-hand-0.png", "No scavenger ever regretted having good gloves."),
                new ItemVO("clothing_hands_4", "Scavenger's gloves", "Hands", 12, true, true, false, 3, 1, {"fight defence": 5, warmth: 15, "radiation protection": 15, "poison protection": 15}, "img/items/clothing-hand-0.png", "Gloves that protect from almost all environmental hazards."),
                new ItemVO("clothing_hands_5", "Synthetic gloves", "Hands", 14, true, false, false, 3, 2, {"fight defence": 8, warmth: 15, "radiation protection": 15, "poison protection": 15}, "img/items/clothing-hand-0.png", "Gloves made from recycled advanced textiles from before the Fall."),
            ],
            shoes: [
            ...
            artefact: [
                ...
                new ItemVO("artefact_doom_2", "Temple key", "Artefact", 1, false, false, false, 7, 3, null, "img/items/artefact-test.png", "Heavy key with a demonic eel-like ornament so intricately carved it feels almost alive. Strangely cold to the touch."),
                new ItemVO("artefact_doom_3", "Seashell", "Artefact", 1, false, false, false, 9, 5, null, "img/items/artefact-test.png", "Fragile, yellow and light pink shell that must have been looted from a museum."),
        ...
        getFollowerByID: function (id) {
            ...
            var bonuses = {"fight attack": strength};
