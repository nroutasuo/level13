...
function (Ash, WorldCreatorConstants, PlayerActionConstants, UpgradeConstants, ItemVO) {
    ...
    var ItemConstants = {
        ...
        itemDefinitions: {
            ...
            weapon: [
                new ItemVO("weapon1", "Shiv", "Weapon", 1, true, true, false, 2, 2, {atk: 2, spd: 1.1}, "img/items/weapon-shiv.png", "Improvised sharp poking implement."),
                new ItemVO("weapon12", "Knife", "Weapon", 2, true, true, false, 2, 1, {atk: 3, spd: 1}, "img/items/weapon-shiv.png", "A bit sturdier than the shiv."),
                new ItemVO("weapon2", "Spear", "Weapon", 4, true, true, false, 3, 1, {atk: 5, spd: 1}, "img/items/weapon-shiv.png", "Old-fashioned but reliable weapon."),
                ...
                new ItemVO("weapon52", "Scrap Metal Waraxe", "Weapon", 11, true, true, false, 1, 1, {atk: 34, spd: 1.25}, "img/items/weapon-shiv.png", "A formidable axe specifically designed for combat"),
                new ItemVO("weapon58", "Crude Shotgun", "Weapon", 12, true, true, false, 5, 1, {atk: 55, spd: 1}, "img/items/weapon-shiv.png", "Devastating short-range firearm."),
                ...
                new ItemVO("weapon7", "Improvised bazooka", "Weapon", 14, true, true, false, 3, 3, {atk: 205, spd: 1}, "img/items/weapon-shiv.png", "Powerful but heavy and somewhat unreliable construction of pipes, reclaimed weapon parts and improvised ammunition."),
                new ItemVO("weapon8", "Rifle", "Weapon", 15, true, true, false, 3, 3, {atk: 245, spd: 0.75}, "img/items/weapon-shiv.png", "Deadly weapon similar to those that were mass-produced just before the Fall."),
            ],
            clothing_over: [
