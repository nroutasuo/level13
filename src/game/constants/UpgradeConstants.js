...
function (Ash, PlayerActionConstants, TribeConstants, WorldConstants, UpgradeVO) {
    ...
    var UpgradeConstants = {
        ...
        blueprintsByCampOrdinal: {
        	...
        	2: [["unlock_weapon_15", "unlock_clothing_warm", "unlock_building_tradingpost"], [], ["unlock_building_darkfarm"]],
        ...
        upgradeDescriptions: {
            ...
            unlock_building_passage_hole: "Enables building huge structures to bridge levels when there is no existing staircase or elevator, and lays the foundation for more construction projects.",
            ...
            unlock_outgoing_caravans: "Travelling to other factions to trade for goods",
            unlock_building_library: "Concentrated effort to build and store knowledge.",
            unlock_building_inn: "Sometimes strangers pass by the camp. Perhaps we can offer them a place to sleep?",
            ...
            unlock_item_bag2: "The art of crafting durable bags.",
