...
function (Ash, UpgradeData, PlayerActionConstants, TribeConstants, WorldConstants, UpgradeVO) {
	...
	var UpgradeConstants = {
		...
		upgradeDescriptions: {
			...
			improve_building_stable_2: "Improve caravan capacity by taking more pack lizards",
			improve_building_collector_food_2: "Improve traps so they can collect more water.",
			...
			improve_building_temple3: "Improve temples and impress the spirits.",
			...
			improve_building_stable_3: "Create standardized transport containers, improving caravan capacity",
			improve_worker_concrete_3: "A formidable engine powering many industrial processes",
