define([
	...
	createLevels: function(seed) {
		...
		for(var s = WorldCreator.getFirstSector(seed, i); s <= WorldCreator.getLastSector(seed, i); s++) {
		    ...
		    var sectorFeatures = WorldCreator.getSectorFeatures(i, s);
		    var possibleEnemies = WorldCreator.getSectorEnemies(i, s);
		    var numberEnemies = WorldCreator.getSectorEnemyCount(i, s);
