define(['ash', 'game/vos/ResourcesVO'], function (Ash, ResourcesVO) {
    ...
    improvementNames = {
		...
		passageUpElevator: "Elevator Up",
		passageUpHole: "Elevator Up",
		passageDownStairs: "Staircase Down",
		passageDownElevator: "Elevator Down",
		passageDownHole: "Elevator Down",
    ...
    var ImprovementVO = Ash.Class.extend({
        ...
        getCampCoords: function (i) {
            if (!this.campCoords) return null;
            if (this.campCoords.length < i) return null;
            return this.campCoords[i];
        },
        
        setCampCoords: function (i, coords) {
            if (!this.campCoords) this.campCoords = [];
            this.campCoords[i] = coords;
        },
