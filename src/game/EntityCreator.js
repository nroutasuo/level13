	...
	var EntityCreator = Ash.Class.extend({
		...
		createLevel: function (saveKey, pos, levelVO) {
			var level = new Ash.Entity()
				.add(new LevelComponent(pos, levelVO.isCampable, levelVO.isHard, levelVO.notCampableReason, levelVO.habitability, levelVO.raidDangerFactor, levelVO.features, levelVO.minX, levelVO.maxX, levelVO.minY, levelVO.maxY))
